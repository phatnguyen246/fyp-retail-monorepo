...
export const listProductsSchema = {
    query: {
        ...
        properties: {
            ...
            page: { type: "number", coerce: true, integer: true, min: 1 },
            page_size: { type: "number", coerce: true, integer: true, min: 1 },
            sort_field: { type: "string", trim: true, emptyToUndefined: true },
